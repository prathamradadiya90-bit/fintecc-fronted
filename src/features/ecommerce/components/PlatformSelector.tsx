...
const PLATFORMS: { id: EcommercePlatform | 'AUTO'; name: string; tag: string; color: string }[] = [
  { id: 'AUTO', name: 'Auto-Detect', tag: 'Smart Parser', color: 'from-emerald-500/20 to-emerald-500/20 text-emerald-400' },
  ...
  { id: 'Glowroad', name: 'GlowRoad', tag: 'Reseller Report', color: 'from-emerald-500/20 to-emerald-500/20 text-emerald-400' },
  ...
  { id: 'Shop101', name: 'Shop101', tag: 'Orders & GST', color: 'from-emerald-500/20 to-cyan-500/20 text-emerald-400' },
];
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-[var(--color-text-secondary)] flex items-center gap-1">
          <Sparkles className="w-3.5 h-3.5 text-emerald-500" /> 11 Marketplaces Supported
        </span>
      </div>
          ...
          return (
            <button
              ...
              className={`
                ...
                ${
                  isSelected
                    ? 'border-emerald-500 ring-1 ring-emerald-500/30 bg-emerald-500/10 shadow-sm'
