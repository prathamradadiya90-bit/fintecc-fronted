    ...
    <div className="max-w-6xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="text-xs font-semibold uppercase tracking-wider px-2 py-0.5 rounded-md bg-emerald-500/10 text-emerald-600 dark:text-emerald-400">
        ...
        <Link
          href="/calculators"
          target="_blank"
          className="self-start sm:self-auto inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold transition-all hover:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400"
          style={{
      ...
      <div className="mb-5 relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2.5 rounded-xl text-sm transition-all focus:outline-none focus:ring-2 focus:ring-emerald-500/50 shadow-sm"
          style={{
            background: 'var(--color-bg-card)',
            border: '1px solid var(--color-border)',
      ...
      >
        <div className="flex items-center gap-3">
          <div
            className="w-10 h-10 rounded-xl flex items-center justify-center text-emerald-600 dark:text-emerald-400"
            style={{
              background: 'var(--color-bg-card)',
              border: '1px solid var(--color-border)',
            }}
        ...
        <Link
          ...
          target="_blank"
          className="text-xs font-semibold text-emerald-600 dark:text-emerald-400 hover:underline shrink-0 hidden sm:inline-flex items-center gap-1"
        >
