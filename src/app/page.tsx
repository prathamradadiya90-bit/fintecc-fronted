        ...
        <div className="max-w-6xl mx-auto z-10 relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            ...
            <div className="flex flex-col p-8 bg-[#0F1E36] rounded-3xl border border-slate-800/60 hover:border-slate-700 transition-colors">
              <h3 className="text-xl font-bold text-white mb-2 text-center">Starter</h3>
              ...
              <div className="flex items-end justify-center gap-1 mb-10">
                ...
                <span className="text-slate-400 mb-2 font-medium">/mo</span>
              </div>
            ...
            {/* Professional */}
            <div className="flex flex-col p-8 bg-[#0F1E36] rounded-3xl border border-slate-800/60 hover:border-slate-700 transition-colors">
              <h3 className="text-xl font-bold text-white mb-2 text-center">Professional</h3>
              <p className="text-sm text-slate-400 mb-8 text-center h-10">Perfect for growing practices.</p>
              <div className="flex items-end justify-center gap-1 mb-10">
                <span className="text-6xl font-black text-white tracking-tighter">₹1,999</span>
                <span className="text-slate-400 mb-2 font-medium">/mo</span>
              </div>
              <div className="flex flex-col gap-4 mt-auto">
                {[
            ...
            <div className="flex flex-col p-8 bg-[#132342] rounded-3xl border-2 border-indigo-500 relative transform lg:-translate-y-4 shadow-2xl shadow-indigo-500/20">
              ...
              <h3 className="text-xl font-bold text-white mb-2 text-center mt-2">Enterprise</h3>
            ...
            {/* Ultimate */}
            <div className="flex flex-col p-8 bg-[#0F1E36] rounded-3xl border border-slate-800/60 hover:border-slate-700 transition-colors">
              <h3 className="text-xl font-bold text-white mb-2 text-center">Ultimate</h3>
              <p className="text-sm text-slate-400 mb-8 text-center h-10">Full-scale automation.</p>
              <div className="flex items-end justify-center gap-1 mb-10">
                <span className="text-6xl font-black text-white tracking-tighter">₹9,999</span>
                <span className="text-slate-400 mb-2 font-medium">/mo</span>
              </div>
              <div className="flex flex-col gap-4 mt-auto">
                {[
